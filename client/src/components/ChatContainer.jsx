...
const ChatContainer = () => {
  ...
  return selectedUser ? (
          ...
          <div key={index} className={`flex items-end gap-2 justify-end ${msg.
            ...
            <div className='text-center text-xs'>
              <img src={msg.senderId === authUser._id ? authUser?.
                profilePic || assets.avatar_icon : selectedUser?.profilePic || assets.avatar_icon} alt="" className='w-7
                  rounded-full' />
    ...
    bg-white/10 max-md:hidden'>
      <img src={assets.logo_icon} className='max-md:hidden max-w-10' alt="" />
